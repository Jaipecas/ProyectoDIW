                ...
                <div class="row my-4">
                    ...
                    <div class="col-md-12 d-flex justify-content-center">
                        <svg baseprofile="tiny" fill="#ececec" stroke="black" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <path class="Argentina selected-map"
                            ...
                            <path d="M1016.9 185.4l-1.4 0.1-1.1-0.5 0.4-3.5 1.3-0.2 1 1.4-0.2 2.7z" id="LU"
                                name="Luxembourg">
                            </path>
                            <path
                            ...
                            <path class="France selected-map"
                            ...
                            <path d="M592.9 422l-0.5-0.2-0.5-0.5 0.1-0.6 0.2 0.3 0.4 0.4 0.3 0.5 0 0.1z" id="AW"
                                name="Aruba">
                            </path>
